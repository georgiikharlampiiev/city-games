...
let strings = new LocalizedStrings({
    ...
    ru: {
        ...
        you_are_not_a_team_member:"Вы не являетесь участником команды! Только участники команды могут принимать игры. Пожалуйста, вступите в команду или создайте свою",
