...
export class GameEditPubQuiz extends React.Component {
    ...
    constructor(props) {
        ...
        this.renderBlockQuestions = this.renderBlockQuestions.bind(this);
    ...
    addQuestion(blockNumber, questionType){
        const currentGame = this.state.currentGame;
        var questions = [];
    ...
    addBlock(){
        ...
        if(!this.state.currentGame.questions) {
            ...
            questions = this.state.currentGame.questions;
            questions.forEach((q) => {
                if(!blocks[q.blockNumber]){
                    blocks[q.blockNumber] = [];
                }
                blocks[q.blockNumber].push(q)
            });
            questions.push({
                name: strings.question_name,
                description: strings.description,
    ...
    renderBlocks(questions) {
        ...
        return this.renderBlockQuestions(blocks);
    }

    renderBlockQuestions(blocks) {
        return blocks.map((block, index) => {
            return (
                <div key={"block-"+index}>
                    <legend>Block number {index}</legend>
                    <div className="form-group">
                        <label className="col-md-3 control-label">Questions</label>
                        <div className="col-md-9 inputGroupContainer">
                            <SortableList items={{items: block, owner: this}} onSortEnd={this.onSortEnd} pressDelay={200} />
                        </div>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <div className="col-md-4">
                            <Button bsStyle="success" onClick={() => this.addQuestion(index, "0")}>Add simple question <span className="glyphicon glyphicon-plus" /></Button>
                        </div>
                    </div>
                    <div className="form-group">
                        {/*<label className="col-md-4 control-label"></label>*/}
                        <div className="col-md-4">
                            <Button bsStyle="success" onClick={() => this.addQuestion(index, "1")}>Add audio question <span className="glyphicon glyphicon-plus" /></Button>
                        </div>
                    </div>
                    <div className="form-group">
                        {/*<label className="col-md-4 control-label"></label>*/}
                        <div className="col-md-4">
                            <Button bsStyle="success" onClick={() => this.addQuestion(index, "2")}>Add video question <span className="glyphicon glyphicon-plus" /></Button>
                        </div>
                    </div>
                </div>
            )
    ...
    render() {
        return (
            <div>
                {/*<!-- Form Name -->*/}
                <legend>Create/edit game type pub-quiz</legend>
                ...
                <div className="form-group">
                    <label className="col-md-1 control-label">Questions</label>
                    <div className="col-md-11 inputGroupContainer">
                        {this.renderBlocks(this.state.currentGame.questions)}
                    </div>
                </div>
                ...
                <div className="form-group">
                    {/*<label className="col-md-4 control-label"></label>*/}
                    <div className="col-md-4">
                        <Button bsStyle="success" onClick={this.addBlock}>Add block <span className="glyphicon glyphicon-plus" /></Button>
                    </div>
                </div>
    ...
    function renderFieldset(item){
        if(item.questionType == 0){
            ...
            return (
                    ...
                    <div className="form-group">
                        <label className="col-md-2 control-label">Audio Question name</label>
                        <div className="col-md-10 inputGroupContainer">
                            <div className="input-group">
                                <input name={ "question_name"+value.index } className="form-control"  type="text"
                                       value={ item.name }
            ...
            return (
                <fieldset>
                    ...
                    <div className="form-group">
                        <label className="col-md-2 control-label">Video Question name</label>
                        <div className="col-md-10 inputGroupContainer">
                            <div className="input-group">
                                <input name={ "question_name"+value.index } className="form-control"  type="text"
                                       value={ item.name }
